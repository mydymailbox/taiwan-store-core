...
/**
 * 台灣 22 縣市 → 鄉鎮市區清單。
 * Keys 為 WooCommerce TW state codes（ISO 3166-2:TW），與 tw-states.php 一致。
 * 6 直轄市為完整清單；其餘縣市後續可依政府開放資料擴充。
 */
...
return [
	...
	'KHH' => [
		...
		'三民區', '楠梓區', '小港區', '左營區', '仁武區', '大社區',
		'岡山區', '路竹區', '阿蓮區', '田寮區', '燕巢區', '橋頭區', '梓官區',
		'彌陀區', '永安區', '湖內區', '鳳山區', '大寮區', '林園區', '鳥松區',
		'大樹區', '旗山區', '美濃區', '六龜區', '內門區', '杉林區', '甲仙區',
		'桃源區', '那瑪夏區', '茂林區', '茄萣區',
	],
	'KEE' => [ '仁愛區', '信義區', '中正區', '中山區', '安樂區', '暖暖區', '七堵區' ],
	'HSZ' => [ '東區', '北區', '香山區' ],
	'HSQ' => [
	...
	'IUH' => [
		...
		'琉球鄉', '車城鄉', '滿州鄉', '枋山鄉', '三地門鄉', '霧台鄉', '瑪家鄉',
		'泰武鄉', '來義鄉', '春日鄉', '獅子鄉', '牡丹鄉', '東港鎮',
	],
	'TTT' => [
	...
	'PEN' => [ '馬公市', '湖西鄉', '白沙鄉', '西嶼鄉', '望安鄉', '七美鄉' ],
	'KIN' => [ '金城鎮', '金沙鎮', '金湖鎮', '金湖鎮', '烈嶼鄉', '烏坵鄉' ],
	'LIE' => [ '南竿鄉', '北竿鄉', '莒光鄉', '東引鄉' ],
];
